          ...
          <AnimatePresence mode="popLayout">
            {filteredItems.map((item, index) => (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-xl border border-white/5 bg-neutral-900 aspect-[4/5] cursor-pointer"
              ...
              >
                ...
                {/* Grid Overlay Layer */}
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/35 to-transparent opacity-60 group-hover:opacity-90 transition-opacity duration-300" />

                {/* Grid text markers */}
                <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end transform translate-y-3 group-hover:translate-y-0 transition-transform duration-300">
                  <span className="font-mono text-[9px] tracking-widest text-amber-500 uppercase mb-2 flex items-center gap-1.5">
                    <Sparkles className="w-3.5 h-3.5" />
                    {item.style}
                  </span>
                  
                  <h4 className="text-base font-sans font-extrabold text-white uppercase tracking-tight mb-1">
                    {item.title}
                  </h4>
            ...
            >
              ...
              >
                ...
                <div className="w-full md:w-80 p-6 md:p-8 flex flex-col justify-between text-left space-y-6">
                  <div>
                    <span className="font-mono text-[9px] tracking-widest text-amber-500 uppercase block mb-2">
