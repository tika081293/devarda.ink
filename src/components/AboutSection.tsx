...
export default function AboutSection() {
  return (
    <section id="about" className="relative bg-neutral-950 py-24 px-6 md:px-12 lg:px-24 border-b border-white/[0.03] overflow-hidden">
      ...
      <div className="absolute top-1/4 right-0 w-[400px] h-[400px] rounded-full bg-gold-500/[0.015] blur-[150px] pointer-events-none" />
          ...
          >
            <div className="space-y-3">
              ...
              <h2 className="text-3xl md:text-5xl font-sans font-light text-white tracking-tight leading-tight uppercase">
                Redefining the <br />
                <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-neutral-100 to-gold-500">Skin Craft Experience</span>
              </h2>
              <span className="font-hand text-3xl text-gold-500/90 block lowercase tracking-widest mt-1">
            ...
            <div className="grid grid-cols-2 gap-6 pt-4 border-t border-white/[0.04]">
              <div className="flex gap-4 items-start">
                <ShieldCheck className="w-5 h-5 text-gold-500 shrink-0 mt-1" />
                <div>
              ...
              <div className="flex gap-4 items-start">
                <UserCheck className="w-5 h-5 text-gold-500 shrink-0 mt-1" />
                <div>
          ...
          >
            ...
            <div className="relative group overflow-hidden rounded-xl aspect-[4/3] border border-white/10 shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 backdrop-blur-md bg-stone-900/65 border border-white/10 p-5 rounded-lg flex justify-between items-center">
                <div>
                  <span className="font-mono text-[9px] tracking-widest text-gold-400 uppercase block mb-1">OUR PHILOSOPHY</span>
                  <span className="text-sm font-sans font-bold text-white uppercase tracking-tight">"YOUR BODY, THE ENDURING CANVAS"</span>
                </div>
                <div className="font-mono text-xl font-extrabold text-gold-500">100%</div>
              </div>
            </div>

            {/* Behind floating gold-ish outline card */}
            <div className="absolute -bottom-4 -left-4 w-2/3 h-1/2 border-l border-b border-gold-500/20 rounded-bl-xl pointer-events-none z-[-1]" />
          </motion.div>
